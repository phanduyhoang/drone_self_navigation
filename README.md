## Симуляция воздушного VO с замыканием петель (Classic + SuperGlue)

Этот проект содержит простой симулятор, который:
...
- ORB (классический, с замыканием петель)
- SIFT (классический, с замыканием петель)
- AKAZE (классический, с замыканием петель)
